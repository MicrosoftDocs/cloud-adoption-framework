...
Your organization's cloud adoption effort will tend to align towards supporting the requirements of the long-term strategic goals of your cloud journey. Depending on whether you're considering a comprehensive hybrid and multicloud effort, or preparing for Kubernetes and container integration into your cloud strategy, we have updated guidance for a [Hybrid and multicloud adoption scenario](https://docs.microsoft.com/azure/cloud-adoption-framework/scenarios/hybrid/scenario-overview), and a [Modern containers adoption scenario](https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/scenarios/aks/).

## Cloud adoption antipatterns

You may encounter missteps with design, planning, or implementation when migrating to the cloud. We have updated detailed guidance on [Antipatterns](https://docs.microsoft.com/azure/cloud-adoption-framework/antipatterns/antipatterns-to-avoid), that can block innovation and prevent businesses from adopting and realizing goals.  
