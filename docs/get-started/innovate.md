...
![The Cloud Adoption Framework methodologies, including Innovate.](../_images/get-started/innovation-map.png)

_Figure 1: The Cloud Adoption Framework methodologies, including Innovate._
...
- Use the AI Maturity Model tool to assess your organization's AI maturity and create AI-based systems.
