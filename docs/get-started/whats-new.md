...
- [Governance considerations for the Azure Integration Services landing zone accelerator](../scenarios/app-platform/integration-services/governance.md): We clarified the governance definition and updated automation recommendations to include GitHub Actions, Azure DevOps Pipelines, Bicep, and Terraform. We also added disaster recovery resource links for Logic Apps, Function Apps, and Data Factory.
