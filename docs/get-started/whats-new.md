...
- [Monitor a cloud environment](../manage/monitor/monitoring.md): Explore an all new reference table providing links to monitoring guidance for various Azure services and resources. This table helps you quickly find the monitoring guidance you need for your specific Azure resources.
...
- [Business continuity and disaster recovery considerations for Oracle Database@Azure](../scenarios/oracle-iaas/oracle-disaster-recovery-oracle-database-azure.md): Find new design considerations and recommendations for multiple-zone and multiregional BCDR architectures, extended BCDR scenarios, backup recommendations, and additional best practices for maintaining data resilience and automating failover operations.
- [Identity and access management for Oracle Database@Azure](../scenarios/oracle-iaas/oracle-iam-odaa.md): Find detailed guidance on managing identities and role-based access control (RBAC) across both Azure and Oracle Cloud Infrastructure (OCI). New sections cover considerations for private offers, default group creation, custom group names, federation with non-Microsoft identity providers, and enhanced RBAC permissions.
- [Migration Planning for Oracle on Azure](../scenarios/oracle-iaas/oracle-migration-planning.md): Explore detailed migration scenarios, including lift-and-shift approaches for applications and databases. Updates include new sections on Oracle Database@Azure migration, online and offline migration paths, and an ExpressRoute-based migration duration reference table.

#### Azure Landing Zone updates

- [Deploy Azure landing zones by using Terraform](../ready/landing-zone/deploy-landing-zones-with-terraform.md): Explore new guidance on various network architectures, including multiple-region virtual WAN with Azure Firewall, multiple-region hub and spoke virtual network, and single-region virtual WAN with Azure Firewall. Explore Azure Verified Modules for Platform Landing Zones Terraform for infrastructure as code deployments.
...
- [What is an Azure landing zone?](../ready/landing-zone/index.md): Fine updated guidance on the use of Bicep and Terraform for deploying platform landing zones and a more detailed description of the Azure Platform Landing Zones Portal Accelerator.
