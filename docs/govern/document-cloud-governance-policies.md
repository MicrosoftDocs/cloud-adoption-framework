...
| SC02 | Security | [R02](assess-cloud-risks.md#example-risk-list) | Access reviews must be conducted monthly in Microsoft Entra ID Governance. | Ensure data and service integrity | Azure users | Immediate access revocation for noncompliance | Governance |
