...
| AI01 | AI | [R08](assess-cloud-risks.md#example-risk-list) | Set AI content filtering configuration to medium or higher. | Mitigate AI harmful outputs | Workload teams | Immediate corrective measures | Microsoft Foundry |
