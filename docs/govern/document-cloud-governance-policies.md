...
| AI01 | AI | [R08](assess-cloud-risks.md#example-risk-list) | AI bias detection and mitigation in Azure OpenAI must be used. | Mitigate AI bias | Workload teams. | Immediate corrective measures | Azure OpenAI |
