...
description: Learn about greater levels of complexity with multiple layers of governance for large enterprises in the Cloud Adoption Framework for Azure.
