...
2. Create a production and nonproduction subscription for each unique combination of discrete business unit or geography. Care should be taken if creating multiple subscriptions. For more information, see the [Subscription decision guide](../../../decision-guides/subscriptions/index.md).
