...
- Create resource groups for applications using the lifecycle approach. Everything that's created, maintained, and retired together should reside in a single resource group. For more information, see [Resource consistency decision guide](../../../decision-guides/resource-consistency/index.md#basic-grouping-resource-groups).
