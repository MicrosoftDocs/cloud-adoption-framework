...
> [!NOTE]
> If you are new to the CAF model's incremental approach, continue on to the next section of this article. It compares the differences between the two guides, and its examples will help you determine which guide fits your scenario.  
