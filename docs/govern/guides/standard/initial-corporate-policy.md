...
description: Use the Cloud Adoption Framework for Azure to define an initial governance position, early-stage risks, initial policy statements, and early enforcement processes.
