...
|----------|----------------|
| Regulatory compliance | &#9744; Microsoft Purview must be used to monitor sensitive data [(RC01)](./document-cloud-governance-policies.md) <br> &#9744; Daily sensitive data compliance reports must be generated from Microsoft Purview [(RC02)](./document-cloud-governance-policies.md) |
| Security | &#9744; Multifactor authentication (MFA) must be enabled for all users [(SC01)](./document-cloud-governance-policies.md) <br> &#9744; Access reviews must be conducted monthly in Microsoft Entra ID Governance [(SC02)](./document-cloud-governance-policies.md) <br> &#9744; Teams must use the specified GitHub organization for secure hosting of all software and infrastructure code [(SC03)](./document-cloud-governance-policies.md) <br> &#9744; Teams utilizing libraries from public sources must adopt the quarantine pattern [(SC04)](./document-cloud-governance-policies.md) |
| Operations | &#9744; Production workloads should have an active-passive architecture across regions [(OP01)](./document-cloud-governance-policies.md) <br> &#9744; All mission-critical workloads must implement a cross-region active-active architecture [(OP02)](./document-cloud-governance-policies.md) |
| Cost | &#9744; Workload teams must set budgets alerts at the resource group level [(CM01)](./document-cloud-governance-policies.md) <br> &#9744;Azure Advisor cost recommendations must be reviewed [(CM02)](./document-cloud-governance-policies.md) |
| Data | &#9744; Encryption in transit and at rest must be applied to all sensitive data [(DG01)](./document-cloud-governance-policies.md) <br> &#9744; Data lifecycle policies must be enabled for all sensitive data [(DG02)](./document-cloud-governance-policies.md) |
| Resource management | &#9744; Bicep must be used to deploy resources [(RM01)](./document-cloud-governance-policies.md) <br> &#9744; Tags must be enforced all cloud resources using Azure Policy [(RM02)](./document-cloud-governance-policies.md) |
| AI | &#9744; AI bias detection and mitigation in Azure OpenAI must be used [(AI01)](./document-cloud-governance-policies.md) <br> &#9744; Customer-facing AI systems must be red-teamed monthly [(AI02)](./document-cloud-governance-policies.md) |
