...
| Security | &#9744; Multifactor authentication (MFA) must be enabled for all users [(SC01)](document-cloud-governance-policies.md) <br> &#9744; Access reviews must be conducted monthly in Microsoft Entra ID Governance [(SC02)](document-cloud-governance-policies.md) <br> &#9744; Use the specified GitHub organization to host all application and infrastructure code [(SC03)](./document-cloud-governance-policies.md) <br> &#9744; Teams utilizing libraries from public sources must adopt the quarantine pattern [(SC04)](document-cloud-governance-policies.md) |
