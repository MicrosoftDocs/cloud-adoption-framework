...
The following resources offer examples and potential options to consider when developing your Identity Baseline discipline. Use each resource as a starting point for discussions within your cloud governance team and with affected business, and IT teams across your organization to establish the policies and processes needed to manage identity-related risks.

<!-- markdownlint-disable MD033 -->

- [Identity Baseline discipline template](./template.md): Download the template for documenting an Identity Baseline discipline.
- [Business risks](./business-risks.md): Understand the motives and risks commonly associated with the Identity Baseline discipline.
- [Indicators and metrics](./metrics-tolerance.md): Indicators to understand if it is the right time to invest in the Identity Baseline discipline.
- [Policy adherence processes](./compliance-processes.md): Suggested processes for supporting policy compliance in the Identity Baseline discipline.
- [Maturity](./discipline-improvement.md): Align cloud management maturity with phases of cloud adoption.
- [Toolchain](./toolchain.md): Azure services that can be implemented to support the Identity Baseline discipline.
