...
- [Learn more](https://docs.microsoft.com/azure/dms/dms-overview) about the Azure Database adoption Service.
...
- [Review](https://docs.microsoft.com/azure/migrate/contoso-adoption-assessment) a sample assessment for the fictional Contoso company.
...
- [Learn how to](https://docs.microsoft.com/azure/cost-management-billing/costs/tutorial-acm-opt-recommendations?toc=/azure/billing/toc.json) optimize cost from recommendations, and [prevent unexpected charges](https://docs.microsoft.com/azure/billing/billing-getting-started).
...
- We recommend evaluating and setting up the logging immediately after completing a adoption, so that you aren't spending money retaining logs of no importance.
