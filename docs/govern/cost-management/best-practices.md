...
- **Licensing alignment:** Proper allocation of Azure Hybrid Benefits and Azure Reserved Instances will significantly reduce your per unit cost for assets across your portfolio. While these licenses are generally established and maintained by central procurement functions, the the decentralized workload teams may want to be consulted on purchase and allocation of the licenses.
...
- **Shut down & deprovision unused resources:** Unused assets add cost in a cloud environment. Identify and terminate any resources that are adding to costs, but are not adding to business value.
...
- **Licensing alignment:** The most immediate cost impact on a large portfolio of workloads will come from a well-planned acquisition strategy. Purchase and allocation of Azure Hybrid Benefits, Reserved Instances, Spot VMs and other buying strategies will rapidly reduce costs across your entire cloud portfolio. 
