...
Cloud governance is a set of guardrails you use to control all cloud use. These guardrails are the specific policies, procedures, and tools you use to establish control. Organizations create policies, known as cloud governance policies, to prevent and mitigate unique business risks. Cloud governance policies define acceptable and unacceptable use of cloud services. Cloud governance uses procedures and tools to align all cloud use with these established policies. Successful cloud governance prevents all unauthorized or unmanaged cloud usage.
