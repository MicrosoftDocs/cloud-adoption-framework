...
Successful cloud governance eliminates all instances of ungoverned cloud usage, such as shadow IT. Cloud governance uses guardrails to regulate the use of all cloud services. Guardrails help ensure that cloud use follows predefined rules. These rules are called cloud governance policies. Cloud governance policies define what's allowed and what isn't allowed in the cloud. Organizations create their own cloud governance policies to prevent and mitigate risks unique to their business. The goal of cloud governance is to ensure cloud use aligns with established cloud governance policies.
