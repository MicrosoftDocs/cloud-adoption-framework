...
- Determine network boundary policies for your [Software Defined Networking (SDN)](/azure/cloud-adoption-framework/ready/landing-zone/design-area/network-topology-and-connectivity) design to ensure secure virtualized networking capabilities.
