...
description: Learn an approach to creating processes that support an Resource Consistency governance discipline in the Cloud Adoption Framework for Azure.
