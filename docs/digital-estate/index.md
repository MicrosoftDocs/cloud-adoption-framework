...
- **Business continuity:** Business continuity and resiliency are fundamentals for an organization to operate. Business needs to run as usual with near-zero downtime, so service relaibility needs to be considered upfront and not as an after thought.
