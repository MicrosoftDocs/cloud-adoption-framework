...
- Applications that are part of _cost of goods sold_ (COGS) within your company. Example: every instance of company x's widget contains an Azure IoT module that sends telemetry. This may necessitate a dedicated subscription for accounting/governance purposes as part of COGS.
