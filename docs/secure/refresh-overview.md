...
- **Security is a team sport:** Defending against these attacks requires a coordinated approach across business, technology, and security teams to each do their part for security and to all work together collaboratively. This point is illustrated by the wide variety of roles required to secure Azure resources described in the [Teams and roles](./refresh-teams-and-roles) article.
...
> [Understand cloud security teams, roles, and functions](./refresh-teams-and-roles.md)