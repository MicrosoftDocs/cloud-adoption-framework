...
The key tenets of success for this are
 - **Continuous discovery of assets and asset types** - The cloud is a dynamic environment where new types of services are added regularly and workload owners dynamically spin up and down instances of applications and services as needed. Governance teams need to perform continuously discover assets types and instances to keep up with this pace of change. 
