...
>[!Note]
>Asset protection is typically implemented by IT Operations teams that maintain the assets and is often supplemented by expertise in the security team. See [Designing Controls as a team](#designing-controls-as-a-team) at the end of this article for more information.
