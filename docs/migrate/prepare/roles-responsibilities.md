...
| Role | Responsibilities |
| --- | --- |
| Program Manager | Organize project management activities across multiple project scopes. |
| Migration Architecture Lead | Drive technical excellence across multiple migration architect scopes. |
