...
Prior to replication, you should have completed the activities in the Prepare and assessment phase. To begin replicating, you need to have:
...
- Any dependencies for your workload that you identified during the Architect Workloads step, such as the resource groups, virtual networks, and subnets you intend to deploy the replicated virtual machines inside of. For more information, see [deploy supporting services](../deploy/deploy-supporting-services.md).
