...
- **Power down source servers**. If you still have source servers available after hydrating your resources, power them down so that they don't interfere with your migration. If you need to revert back, you can power on these servers after cleaning up the migration items.
