...
For further information on tagging refer to [Azure Architecture Center's naming conventions for Azure resources](../../ready/azure-best-practices/naming-and-tagging.md#metadata-tags)
