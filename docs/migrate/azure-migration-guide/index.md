...
This article guides you through a simplified migration process from your on-premises environment to Azure.
...
> - [**Manage costs.**](manage-costs.md) Understand the tools required for migration-focused cost control mechanisms in Azure.
> - [**Release workloads.**](optimize-and-transform.md) Optimize for cost and performance balance before you promote your workload to production.
