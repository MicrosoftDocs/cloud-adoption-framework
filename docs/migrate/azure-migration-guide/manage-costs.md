...
[Azure Dev/Test pricing](https://azure.microsoft.com/en-us/pricing/dev-test) gives customers access to select Azure services for nonproduction workloads at discounted pricing under the Microsoft Customer Agreement. This plan reduces the costs of running and managing applications in development and testing environments, across a range of Microsoft products.
