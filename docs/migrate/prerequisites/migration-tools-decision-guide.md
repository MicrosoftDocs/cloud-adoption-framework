...
- **Do you require real-time protection of data while it's in use?**
[Confidential computing on Azure](/azure/confidential-computing/overview-azure-products) applies to various [data protection use cases](/azure/confidential-computing/use-cases-scenarios) for protecting data in regulated industries, such as government, financial services, and healthcare institutes. Confidential computing provides encryption while in use by protecting sensitive or highly regulated datasets and application workloads in a secure public cloud platform.
