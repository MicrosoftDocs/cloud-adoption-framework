...
Each SQL operation in Azure Synapse together with the resources used by that query (such as memory or CPU) is logged into system tables and a series of dynamic management views (DMVs) are provided to simplify access to this information.
