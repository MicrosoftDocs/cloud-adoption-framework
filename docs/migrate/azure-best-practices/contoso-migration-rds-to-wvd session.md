...
- Take advantage of existing [Microsoft 365 licenses](https://learn.microsoft.com/azure/virtual-desktop/prerequisites#operating-systems-and-licenses) on Azure Virtual Desktop.
