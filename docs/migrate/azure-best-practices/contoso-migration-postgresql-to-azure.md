---
title: "Migrate PostgreSQL to Azure (scenario) "
...
# Migrate PostgreSQL to Azure (scenario)
...
- Preparation:
  ...
  - Setup a virtual network (VNet) to access the database:
...
- Migration:
  ...
  - Select **Save**.
  - Give the activity a name, then select **Run**.
