...
- After deploying resources, Contoso assigns Azure tags as defined during the [Azure infrastructure](../azure-migration-guide/ready-alz.md#set-up-tagging) deployment.
