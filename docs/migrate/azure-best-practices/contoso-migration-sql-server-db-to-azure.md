...
Learn more about [Data Migration Assistant](/sql/dma/dma-assesssqlonprem?view=sql-server-2017)
...
The project will step you through the key decisions required. [Select this link](https://azuredevopsdemogenerator.azurewebsites.net/?name=sqlmigration) to go to the Azure DevOps project.

>>>>>>> 6fb54a55a864d1022e1a12cdf8cec3b62e419cfc
