...
- The Contoso team reviews the backup requirements for the database in Azure SQL Managed Instance. [Learn more](https://docs.microsoft.com/azure/sql-database/sql-database-automated-backups).
