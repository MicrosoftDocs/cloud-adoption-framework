...
description: Learn how Contoso rehosts an on-premises app by migrating it to an Azure App Service web app and Azure SQL Managed Instance.
author: givenscj
ms.author: abuck
ms.date: 04/02/2020
ms.topic: conceptual
...
> - **Step 2: Migrate via Azure Database Migration Service.** Contoso migrates the app database via Azure Database Migration Service.
