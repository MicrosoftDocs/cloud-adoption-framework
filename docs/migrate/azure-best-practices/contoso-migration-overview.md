...
| Article | Details |
| --- | --- |
| [Move on-premises Remote Desktop Services to Azure Virtual Desktop in Azure](./contoso-migration-rds-to-wvd.md) | This article shows how to migrate on-premises Remote Desktop Services to Azure Virtual Desktop in Azure. |
