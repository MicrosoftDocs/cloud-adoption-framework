...
1. In **Create Virtual Machine Wizard** > **Basics**, configure:
...
1. In **Size**, start with `D2S v3` instances for both VMs. Scale later as needed.
1. In **Settings**, the admin does the following actions:
