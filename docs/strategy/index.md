...
| <br> :::image type="icon" source="../_images/icons/3.png"::: | <br> [Understand financial considerations](./cloud-migration-business-case.md): Learn how to use the cloud to make your IT cost structure more flexible and build a business case to migrate to the cloud. |
| <br> :::image type="icon" source="../_images/icons/4.png"::: | <br> [Understand technical considerations](./first-adoption-project.md): Discover the technical flexibility, efficiencies, and capabilities that help you build a business case to migrate to the cloud. |
