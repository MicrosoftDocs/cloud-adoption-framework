---
title: Determine Your Motivations, Mission, and Objectives
description: Learn how to use the Cloud Adoption Framework for Azure to understand the motivations, mission, and objectives behind cloud migration that can help produce more successful business outcomes.
ms.author: pnp
