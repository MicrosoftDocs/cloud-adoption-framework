...
- _Educate your workload teams._ Use the Azure Well-Architected Framework [sustainable workload guidance](/azure/well-architected/sustainability/) to help teams understand the best practices for enhancing workloads while reducing the environmental footprint.
