...
- **Example:** An online retailer who ships products globally can engage with their customers across time zones and multiple languages leveraging an Azure Bot Service solution together with Cognitive Services such as Translator, Language Understanding, QnA Maker, Text Analytics. This ensures their customers are able to get the information they need when they need it, and it is provided to them is their language. The retailer leverages Personalizer service to further customize the experience and catalog offering for their customers ensuring geographical tastes, preferences, and availability are reflected.
