...
The operational phase runs continuously to maintain security, optimize performance, and ensure compliance across your Azure environment. These three methodologies operate in parallel to deliver operational excellence that scales with your business growth. Begin operational excellence planning during Strategy and Plan phases, as these methodologies become mission-critical when workloads reach production scale and serve business-critical functions.
...
- **Looking for industry-specific solutions?** [Explore cloud adoption scenarios](#what-specific-scenarios-does-the-cloud-adoption-framework-address) for AI implementation, data analytics modernization, hybrid multicloud, and enterprise applications
