...
3. Type a name for your new project. When deployed to your Azure DevOps tenant, the cloud adoption plan has this name.
4. Select **Create Project** to create a project in your tenant based on the strategy and plan template. A progress bar shows your progress toward the deployment of the project.
5. When the deployment is finished, select **Navigate to the project** to see your new project.

After creating your project, continue through this article series to learn how to modify the template to align to your cloud adoption plan.
...
After you deploy your project plan, you can use Microsoft Excel to modify it. It's easier to create workloads or assets using Microsoft Excel than the Azure DevOps browser experience.
...
- **Features:** Features organize specific objectives within each phase. For instance, migration of a specific workload is a feature.
...
At each layer, activities are sequenced based on dependencies. Activities are linked to articles in the Cloud Adoption Framework to clarify the objective or task.
...
The following articles support the alignment of the cloud adoption plan:
...
- [Establish timelines](./timelines.md): To define each iteration's start and end dates, create a timeline to manage the overall project.

These five articles help with the alignment tasks required to manage your adoption efforts. The next step gets you started on the alignment exercise.
