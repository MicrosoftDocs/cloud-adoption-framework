...
- **Technical policy:** Apply guardrails to audit and enforce the organizations standards and policies to technical systems. See Azure Policy and [Azure Blueprints](https://docs.microsoft.com/azure/governance/blueprints/overview).
