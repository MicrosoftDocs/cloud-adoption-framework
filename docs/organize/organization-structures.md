...
> [!WARNING]
> Operating with only a cloud adoption team (or multiple cloud adoption teams) is considered an antipattern and must be avoided. At a minimum, consider the [MVP best practice](#best-practice-minimum-viable-product-mvp).
...
![Diagram that shows the cloud center of excellence (CCoE)](../_images/ready/org-ready-ccoe.png)
