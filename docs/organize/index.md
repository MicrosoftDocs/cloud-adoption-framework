...
| <br> :::image type="icon" source="../_images/icons/4.png"::: | <br> [RACI matrix](../strategy/prepare/raci-alignment.md): Use the provided RACI matrix to map roles to each team for functions of the cloud operating model. This matrix includes responsibility, accountability, consulted, and informed roles. |
