...
- **Models.** [Microsoft Foundry Models](/azure/foundry/concepts/foundry-models-overview) includes models sold by Azure and models from partners and community. The options include models from OpenAI, Anthropic, Meta, and Mistral.
...
:::image type="content" source="./images/technology-options.png" alt-text="Diagram that shows ready-to-use vs. build technology options. Compare Microsoft SaaS agents (ready-to-use) vs. Low-code (Microsoft Copilot Studio) and pro-code (Foundry) build options." lightbox="./images/technology-options.png" border="false":::
