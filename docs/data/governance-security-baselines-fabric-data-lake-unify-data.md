...
*Figure 1.* **Single Lakehouse with multiple schemas with** *One data product per Fabric workspace.*
...
*Figure 2.* **Multiple Lakehouses for medallion layers with** *One data product per Fabric workspace.*
