...
# Azure innovation guide: Engage customers through applications
...
2. Configure a new application: select **Add** and follow the prompts.
3. Manage existing applications: select the desired application from the list of function apps.
...
1. Go to **Logic Apps**.
2. Configure a new application: select **Add** and follow the prompts.
3. Manage existing applications: select the desired logic app from the list.
...
<!-- docsTest:ignore "Serverless API management" -->
