...
[Azure Machine Learning](/azure/machine-learning/) lets you deploy custom-built algorithms, which you can create and train based solely on your own data. Learn more about deploying predictions with [Azure Machine Learning](/azure/machine-learning/how-to-deploy-and-where).
...
- [Kubernetes in the Cloud Adoption Framework](.\innovate\kubernetes\index.md)
- [AI in the Cloud Adoption Framework](.\innovate\ai\index.md)
