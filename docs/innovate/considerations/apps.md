...
In parallel, Azure provides serverless transaction data options that also reduce overhead. The [database products list](/azure/) provides options for hosting data without the need for a full data platform.
