...
- [Azure Sphere](https://docs.microsoft.com/azure-sphere), a combination of hardware and software. Azure Sphere is an innately secure way to enable an existing device to securely transmit data between the device and Azure IoT solutions.
- [Azure Kinect Developers Kit](https://docs.microsoft.com/azure/Kinect-dk), AI sensors with advance computer vision and speech models. These sensors can collect visual and audio data from the immediate surroundings and feed those inputs into your solution.
