...
Microsoft established an ethical committee for AI, ethics, and effects in engineering and research [Aether](https://www.microsoft.com/ai/our-approach?activetab=pivot1%3aprimaryr5), in 2017. The core responsibility of the committee is to advise on responsible issues, technologies, processes, and best practices. To learn more, see [Understanding the Microsoft governance model - AETHER + Office of Responsible AI](/learn/modules/microsoft-responsible-ai-practices/3-microsoft-governance-model).
