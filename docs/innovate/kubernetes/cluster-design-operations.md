...
A minimum of two pods behind an kubernetes service will ensure HA of your application in case of pod failures or restarts. Recommended is 3 or more to take care of load during pod failures and restarts. 
For the cluster setup - a minimum of 2 nodes in VM - Availability set or VM Scale sets is required for the SLA guarantee of 99.95%. Recommended is 3 to ensure pod scheduling during node failures and reboots. 
