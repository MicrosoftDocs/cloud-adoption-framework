...
|---|---|---|---|---|---|---|---|----| --- |
| Workload name | Classification label | Add details | Add details | Add details | Add details | Add details | Add details | Add details | Add details |
...
| Operator access | Control:  [Customer Lockbox](/azure/security/fundamentals/customer-lockbox-overview) <br>EU and EFTA control: [Data Guardian](/azure/azure-sovereign-clouds/public/data-guardian) <br><br>Enforcement: [Enable Customer Lockbox](/azure/security/fundamentals/customer-lockbox-overview#enable-customer-lockbox-for-microsoft-azure) | Controls: Customer operator, identity access for [connected](/azure/azure-local/assurance/azure-stack-iso27001-guidance) and [disconnected](/azure/azure-local/manage/disconnected-operations-security#security-and-compliance-overview)  <br><br>Enforcement: Manual | Partner-specific |
| Operator auditing | Control: [Immutable ledger](/azure/azure-sovereign-clouds/public/data-guardian#why-it-matters) <br><br>Enforcement: Manual | Controls: Customer operator<br><br>Enforcement: Manual | Partner-specific |
