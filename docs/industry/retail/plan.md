...
- **Analytics-driven retail:** Use the cloud to standardize, integrate, and manage data in ways never possible in siloed or even connected retail environments. The [Cloud-scale analytics](../../scenarios/cloud-scale-analytics/index.md) scenario establishes the processes and environment needed to create an enterprise-wide approach to data management which unlocks centralized analytics.
