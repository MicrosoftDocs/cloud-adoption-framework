...
|-------------------------------|----------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| Cloud monitoring              | [Azure Monitor](/azure/azure-monitor)                                | Serves as the central platform that collects telemetry from cloud and on‑premises environments. It monitors resource performance and operational state. |
| Multi-environment monitoring  | [Azure Arc](/azure/azure-arc/overview)                               | Extends Azure management—including monitoring and governance—to on‑premises, multicloud, and edge environments.                                        |
...
| Security monitoring           | [Microsoft Entra monitoring](/azure/entra/identity/monitoring-health/overview-monitoring-health) | Tracks identity interactions, sign‑in health, and audits changes to user accounts to safeguard access.                                                  |
...
| Compliance monitoring         | [Microsoft Purview Compliance Manager](/azure/purview/compliance-manager) | Assesses regulatory compliance and provides insights and recommendations to reduce risk.                                                                |
...
| Data monitoring               | [Microsoft Purview](/azure/purview/purview)                          | Governs and protects enterprise data by offering discovery, classification, and risk management capabilities.                                           |
