...
| Inventory and visibility | Visualize Data | Microsoft Sentinel | Instant visualization and analysis of data | [Sentinel visualize collected data](/azure/sentinel/get-visibility) |
...
| Operational compliance | Zero trust | Microsoft Sentinel | Zero Trust workbook uses the full breadth of Microsoft security offerings |[Sentinel Zero trust Workbook](/azure/sentinel/whats-new#zero-trust-tic30-workbook) |
...
| Protect and recover | Threat Hunting | Microsoft Sentinel | Built in hunting queries that help you detect and protect against malicious activity  | [Sentinel Threat Hunting](/azure/sentinel/hunting) |
...
Microsoft Sentinel can be enabled at no additional cost on an Azure Monitor Log Analytics workspace for the first 31-days. See more [Microsoft Sentinel Pricing](https://azure.microsoft.com/pricing/details/microsoft-sentinel/).

### Learn more about Microsoft Sentinel

To explore Microsoft Sentinel, go to the [Azure portal](https://portal.azure.com/#blade/HubsExtension/BrowseResource/resourceType/microsoft.securityinsightsarg%2Fsentinel)

To learn more, see [Microsoft Sentinel documentation](/azure/sentinel/).

Want to become a Microsoft Sentinel Ninja, see [Microsoft Sentinel Ninja Training](https://techcommunity.microsoft.com/t5/azure-sentinel/become-an-azure-sentinel-ninja-the-complete-level-400-training/ba-p/1246310)
