...
This section compares several platform and infrastructure factors for Azure Monitor, System Center Operations Manager (Operations Manager), and System Center Operations Manager Managed Instance (SCOM Managed Instance).

| Requirement | Azure Monitor<br>_(without Azure Monitor SCOM Managed Instance features)_ | Operations Manager | SCOM Managed Instance |
|---|---|---|---|
...
| Web app availability test (isolated network) | Yes, limited.<br><br>Azure Monitor has limited support in this area and requires custom firewall exceptions. | Yes | Yes, limited.<br><br> SCOM Managed Instance supports this from agents or management server resource pools.|
