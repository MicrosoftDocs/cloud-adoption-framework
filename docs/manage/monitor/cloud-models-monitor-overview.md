...
| Azure service monitoring | Yes | Yes <br><br> Although there's no native monitoring of Azure service health provided today through a management pack, you can create custom workflows to query Azure service health alerts. Use the Azure REST API to get alerts through your existing notifications. |
