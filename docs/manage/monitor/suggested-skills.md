...
- [How to monitor your VMs](https://www.youtube.com/watch?v=O7scXPrsM_0 index=6 t=0s list=PLLasX02E8BPCDMuesOy2C0_TMFsoZWe_0) provides an intermediate level deep dive to help you learn about monitoring your hybrid machines or servers, and Azure VM or virtual machine scale sets with Azure Monitor for VMs.
