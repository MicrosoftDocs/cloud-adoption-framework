...
-- **Sensitive data**: What sensitive data should I avoid collecting for application *x* in application error messages which I do not want to expose to my operators?
