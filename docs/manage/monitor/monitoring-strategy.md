...
| Threat management and integrated threat protection | The cloud brings together the separate, traditional roles of security monitoring with health monitoring. Integrated Threat Protection for example involves monitoring to accelerate an optimal state of Zero Trust. Integrating Azure Advanced Threat Protection allows a migration from System Center Operations Manager monitoring Active Directory to integrate your AD signals and detect advanced attacks in hybrid environments. |
