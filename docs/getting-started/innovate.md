---
title: "Getting started: Build new products and services in the cloud"
...
![Get Started with accelerating innovation in the cloud](../_images/getting-started/innovation-getting-started-map.png)

## Step 1: Document the business strategy

To avoid common blockers, create a clear and concise business strategy for innovation. Stakeholder alignment on motivations and expected business outcomes will shape decisions made by the cloud adoption team.
...
- [Motivations](../strategy/motivations.md): The first step to strategic alignment is to gain consensus on the motivations driving the innovation effort. Start by understanding and categorizing motivations and common themes from various stakeholders across business and IT.
...
In most enterprises, innovation can be accelerated through the use of existing assets such as, applications, vms, and data. When planning for innovation, it is important to understand how and when those assets will be migrated to the cloud.
...
Discovery and assessment provide a deeper level of technical alignment to create an actionable plan to migrate any dependent workloads required by the planned innovation. This is very common when companies have existing data sources, centralized applications, or required service layers which are needed to deliver the innovation within the context of the rest of the enterprise. When there are dependent systems the following articles can guide the discovery and assessment.
...
- [People & time alignment](../plan/iteration-paths.md): Establish iteration, velocity (people's time), and releases for the workloads

## Step 5: Align governance requirements to your adoption plan

Discussing planned innovations with the governance team helps you avoid a number of blockers before they arise. At times innovative new solutions may require practices that are discouraged in sound governance practices. Some of those required features may even be blocked through automated governance enforcement tooling.
...
- [Governance approach](../govern/index.md): This methodology outlines a process for thinking about corporate policy and processes, and then building the disciplines required to deliver on governance across your cloud enterprise efforts.
...
Define the plan for long-term operational responsibilities regarding the planned innovation. Will the established management baseline be sufficient to meet your operational needs? If not, evaluate options for funding operations that are specific to the technology that supports this innovation.
...
All assets hosted in the cloud live within a landing zone. That landing zone may have explicit governance, security, and operational requirements. Or, it may be a brand new subscription, with no support from other teams. In either scenario, its important to start with a landing zone which aligns to governance and operation requirements from the beginning. Starting with an approved landing zone will help your team discover policy violations early in development, instead of when the solution is released to production. This early discovery helps remove blockers and provides the adoption team and governance team with the time required to implement change.
...
- [Business value consensus](../innovate/business-value.md): If more than three months have passed since the last business value consensus, or if one has never been completed, start here.
