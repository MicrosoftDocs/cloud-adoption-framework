...
description: Learn recommended steps for stakeholder alignment, migration planning, deploying a landing zone, and migrating your first 10 workloads.
...
- [Business Outcomes](../strategy/business-outcomes/index.md): Once motivations are aligned, you can capture the desired business outcomes. This provides clear metrics by which the overall transformation can be measured.
...
- Responsible or supporting teams: [Cloud Adoption Team](../organize/cloud-adoption.md) and [Cloud center of excellence](../organize/cloud-center-of-excellence.md)/[Central IT](../organize/central-it.md)

### Step 2: Make a business case

Making the business case for migration will likely be an iterative conversation among stakeholders. In this first pass at building the business case, evaluate the initial, high-level return from a potential cloud migration.
...
- Accountable team: [Cloud Strategy Team](../organize/cloud-strategy.md)
- Responsible or supporting teams: [Cloud Adoption Team](../organize/cloud-adoption.md)
...
- [Inventory existing systems](../digital-estate/inventory.md): First, understand the current state with a programmatic, data-driven approach.. Discover and gather data to enable all assessment activities.
...
- Responsible or supporting teams: [Cloud Strategy Team](../organize/cloud-strategy.md)
...
All migrated assets are deployed within a landing zone. Initially, the landing zone will be simple to support smaller workloads. Over time, it will scale to address more complex workloads.
...
- Accountable team: [Cloud Adoption Team](../organize/cloud-adoption.md)
- Responsible or supporting teams: [Cloud center of excellence](../organize/cloud-center-of-excellence.md)/[Central IT](../organize/central-it.md)
...
For the majority of adoption patterns, the proceeding steps prepare the broader organization and platform for the migration work in this step. If migration is simply a technical process, skipping to this step may be perfectly acceptable. Some adoption patterns call for a one-time migration, where all assets are moved in a single motion, if that is the case you might be able to jump to this step as well.

Migration execution is an iterative process of its own. Many people refer to migration execution as a migration factory, because each release and each iteration is similar to running a set of workloads and assets through a conveyor belt, migrating each to the cloud.
...
- Accountable team: [Cloud Adoption Team](../organize/cloud-adoption.md)
- Responsible or supporting teams: [Cloud Strategy Team](../organize/cloud-strategy.md) and [Cloud center of excellence](../organize/cloud-center-of-excellence.md)/[Central IT](../organize/central-it.md)
...
|Cloud&nbsp;Governance&nbsp;Team|Use the [Govern](../govern/index.md) methodology to continue to improve governance processes, policies, and disciplines.|
