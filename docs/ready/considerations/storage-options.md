...
| I have an enterprise NAS (such as Azure NetApp Files or Dell-EMC Isilon). | [Azure NetApp Files](/azure/azure-netapp-files/azure-netapp-files-introduction) <br><br> [Azure Files (premium)](/azure/storage/files/storage-files-planning#storage-tiers) | If you have an on-premises deployment of NetApp, consider using Azure NetApp Files to migrate your deployment to Azure. If you're using or migrating to a Windows or Linux server, or you have basic file-share needs, consider using Azure Files. For continued on-premises access, use Azure File Sync to sync Azure file shares with on-premises file shares by using a cloud-tiering mechanism. |
