...
:::image type="content" source="./media/single-usecase-sandbox.png" alt-text="Flowchart that shows a single-use case sandbox architecture." lightbox="./media/single-usecase-sandbox.png#lightbox":::
