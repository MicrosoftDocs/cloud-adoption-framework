...
- [Network boundary security](../../reference/networking-vdc.md): A number of reference patterns for developing a network, similar to how the network boundary is secured in a data center.
