...
This sample Bicep code deploys an Azure Storage Account in the resource group's region, using Standard_LRS redundancy and the StorageV2 kind, with the access tier set to 'Hot' for frequent data access.
