...
To begin testing your first landing zone, refer to guides for [ARM](https://github.com/Azure/AzOps), [Bicep](https://github.com/Azure/ALZ-Bicep), or [Terraform](https://github.com/Azure/caf-terraform-landingzones).
