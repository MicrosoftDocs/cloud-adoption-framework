...
*Figure 1: Azure landing zone conceptual architecture. Download a [Visio file](https://github.com/MicrosoftDocs/cloud-adoption-framework/tree/main/docs/ready/enterprise-scale/media/enterprise-scale-architecture.vsdx) of this architecture.*
