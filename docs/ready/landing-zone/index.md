...
Azure landing zone architecture is scalable and modular to meet a range of deployment needs. It uses repeatable infrastructure to apply configuration and controls to each subscription. It also makes it easy to deploy and modify core capabilities of the Azure landing zone architecture as your requirements evolve.

The Azure landing zone conceptual architecture (*see Figure 1*) represents an opinionated, target architecture for Azure environment. It consists of platform landing zones for central, shared resources and application landing zones to host your applications. Use the conceptual architecture as a starting point and then [tailor the architecture to meet your needs](./tailoring-alz.md).
