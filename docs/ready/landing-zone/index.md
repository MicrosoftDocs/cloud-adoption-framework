...
The Microsoft Cloud Adoption Framework outlines [cloud adoption scenarios](/azure/cloud-adoption-framework/scenarios/overview) to help you further refine and accelerate your cloud adoption journey, for application and workload deployment. There are [Infrastructure as Code implementations or accelerators](/azure/architecture/landing-zones/landing-zone-deploy.md#Application) for each of these scenarios.
