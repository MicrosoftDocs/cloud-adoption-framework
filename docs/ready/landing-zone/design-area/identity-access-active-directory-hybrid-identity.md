...
- When you deploy Domain Services or integrate on-premises environments into Azure, use locations with [availability zones](/azure/reliability/availability-zones-overview) for increased availability when possible. Also consider deploying across multiple Azure regions for increased resiliency.
