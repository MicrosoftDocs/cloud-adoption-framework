...
:::image type="content" source="./media/management-group-environment-antipattern.png" alt-text="Diagram that shows an example of a suboptimal management group hierarchy, with distinct management groups for different environments." lightbox="./media/management-group-environment-antipattern.png":::
