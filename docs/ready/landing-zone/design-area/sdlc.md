...
To prevent this rework, policies should remain consistent throughout promotion of code through SDLC environments. Platform teams should not build policies for each environment, but instead provide a consistent set for all non-Sandbox development environments.
