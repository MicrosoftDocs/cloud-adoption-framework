...
- Are you following guidance in [Why update Azure Landing Zone environments](../../../govern/resource-consistency/why-update-azure-landing-zone.md) to ensure that your Azure Landing Zone environment is up-to-date?
