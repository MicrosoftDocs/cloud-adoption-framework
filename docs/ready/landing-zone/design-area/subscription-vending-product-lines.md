...
:::image type="content" source="./media/sub-vend-product-line1.svg" alt-text="The image depicts an examples of the corp connected subscription vending product line in which there is a network architecture featuring a central 'Routable Hub' with an IP address of 10.1.0.0/24. It is connected to two spokes: 'Landing Zone A' and 'Landing Zone B,' with IP addresses 10.1.1.0/24 and 10.1.2.0/24, respectively. The diagram also shows 'VNet Peering' connections between the hub and the landing zones, as well as additional unspecified landing zones. This setup is typical for a hub-and-spoke network model, which helps in managing network traffic and policies efficiently." lightbox="./media/sub-vend-product-line1.svg" border="false":::
...
:::image type="content" source="./media/sub-vend-product-line2.svg" alt-text="The image depicts an examples of the online subscription vending product line in which there is a network architecture diagram with labeled sections 'Landing Zone A,' 'Landing Zone B,' 'Landing Zone C,' and 'Landing Zone D.' Each section includes icons for network elements like databases and cloud services, interconnected with arrows to show data flow. A central 'Routable Hub 10.0.0/24' with a security lock icon connects to additional landing zones depicted by cloud icons. Importantly none of the vNets are peered together and all use modern services and approaches to interact with each other, such as Private Link." lightbox="./media/sub-vend-product-line.svg" border="false":::
