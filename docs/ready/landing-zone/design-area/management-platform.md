...
| Azure data retention thresholds and archiving requirements | <ul> <li>The default retention period for Azure Monitor Logs is 30 days. You can extend analytics retention and total retention for a table. For more information, see [Manage data retention in a Log Analytics workspace](/azure/azure-monitor/logs/data-retention-configure).</li> <li>The default retention period for Microsoft Entra reports (premium) is 30 days.</li> <li>The default retention period for the Azure Activity logs and Application Insights logs is 90 days.</li> </ul>                                                                                                                                                                                                                                                                                                                 |
