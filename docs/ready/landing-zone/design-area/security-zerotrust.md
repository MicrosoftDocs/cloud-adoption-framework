...
- Review [Security in the Microsoft Cloud Adoption Framework for Azure](../../../../cloud-adoption-framework/secure/index.md) for other guidance on adopting your security framework.
