...
- The Azure landing zone accelerator includes several custom roles for common administrative functions. You can use these roles alongside Azure built-in roles. The following table describes the custom administrative roles or areas for the Azure landing zone accelerator:
   ...
   | Subscription Owner  | Delegated role for the subscription owner  | `*` | `Microsoft.Authorization/*/action`,<br> `Microsoft.Authorization/*/delete`,<br> `Microsoft.Authorization/*/write`,<br> `Microsoft.Network/vpnGateways/*`,<br> `Microsoft.Network/expressRouteCircuits/*`,<br> `Microsoft.Network/routeTables/write`,<br> `Microsoft.Network/vpnSites/*` |
   | Application Owner (DevOps, App operations) | Contributor role for the application or operations team at the subscription scope  | `*` | `Microsoft.Authorization/*/action`,<br> `Microsoft.Authorization/*/delete`,<br> `Microsoft.Authorization/*/write`,<br> `Microsoft.Network/publicIPAddresses/write`,<br> `Microsoft.Network/virtualNetworks/write`,<br> `Microsoft.KeyVault/locations/deletedVaults/purge/action`  |
