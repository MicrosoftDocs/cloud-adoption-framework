...
- [Environments](../../considerations/environments.md) explains the purpose of multiple environments to build, test, and release code with greater speed and frequency. This approach makes deployment as straightforward as possible.
