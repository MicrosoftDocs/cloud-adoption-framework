...
In addition, using Infrastructure as Code can help you monitor for configuration drift, as well as help you keep your landing zone up to date.  Read more about this in these articles on [Keep your Azure landing zone up to date](../../../govern/resource-consistency/keep-azure-landing-zone-up-to-date.md) and [Why use Infrastructure as Code to update your ALZ?](../../../manage/iac-updates.md).
