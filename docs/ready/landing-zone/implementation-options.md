...
| [CAF Terraform landing zones](./deploy-landing-zones-with-terraform.md) | Third-party path for multicloud operating models. This path can limit Azure-first operating models. | Start small | [Design principles](./caf-terraform-landingzones.md) | [Deploy](./caf-terraform-landingzones.md) |
