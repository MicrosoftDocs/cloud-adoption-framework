...
| [ALZ Terraform module](deploy-landing-zones-with-terraform.md) | Deploys an enterprise-ready platform foundation using Terraform. | Enterprise-scale | [Design principles](../enterprise-scale/design-principles.md) | [Deploy](https://registry.terraform.io/modules/Azure/caf-enterprise-scale/azurerm/latest) |
| [CAF Terraform landing zones](./deploy-landing-zones-with-terraform.md) | Third-party path for multicloud operating models. This path can limit Azure-first operating models. | Start small | [Design principles](./caf-terraform-landingzones.md#design-decisions) | [Deploy](./caf-terraform-landingzones.md#customize-and-deploy-your-first-landing-zone) |
...
| [CAF Terraform modules](./caf-terraform-landingzones.md) | Included in virtual datacenter module | Included | Terraform | [Deploy](./caf-terraform-landingzones.md#customize-and-deploy-your-first-landing-zone) |
| [ALZ terraform module](alz-terraform-module.md)  | Excluded | Excluded | Terraform | [Deploy](https://registry.terraform.io/modules/Azure/caf-enterprise-scale/azurerm/latest) |
