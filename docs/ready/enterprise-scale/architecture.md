...
Download the [PDF file](https://github.com/LeeSchuenemeyer/cloud-adoption-framework/blob/master/docs/ready/enterprise-scale-architecture-v2.pdf) that contains this architecture diagram.
