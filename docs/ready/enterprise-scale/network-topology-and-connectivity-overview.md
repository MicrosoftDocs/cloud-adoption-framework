...
[This section provides different connectivity approaches to integrate an Azure Enterprise Scale Landing Zone architecture to other Cloud providers.](docs/ready/azure-best-practices/connectivity-to-other-cloud-providers.md)
