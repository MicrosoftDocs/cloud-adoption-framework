...
- There is a manual process (planned future automation) which can be conducted to limit an AAD tenant to only consider Enterprise Enrollment Subscriptions.
