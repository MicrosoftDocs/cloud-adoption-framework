...
This page can also be used with the [Platform automation and DevOps critical design area](./platform-automation-and-devops.md) guidance as it relates to the “PlatformOps” and “Central functions” teams and tasks.
...
If you do not wish to deploy the entire “canary” environment hierarchy, then testing of platform resources can still be achieved within the “production” hierarchy, using sandbox subscriptions as depicted below.
...
Below is guidance on how to implement and utilize the "canary" Management Group hierarchy for Enterprise Scale alongside a “production” hierarchy:
