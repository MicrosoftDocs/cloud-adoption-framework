...
>[!NOTE]
> You may be able to utilise [Availability Zones](/azure/availability-zones/az-overview#availability-zones) instead of having to deploy into an additional Azure region. You should review and assess if this is possible based on your requirements and whether [Availability Zones are supported in your region and for the services](/azure/availability-zones/az-region) you wish to use.
