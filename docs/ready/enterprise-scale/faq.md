...
See [Software Development Lifecycle in Azure Landing Zones](../landing-zone/sdlc.md) for information about managing development environments in Azure Landing Zones.
