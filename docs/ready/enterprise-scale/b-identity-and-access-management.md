...
- Applications relying on domain services and using older protocol can uses [Azure AD domain services](https://docs.microsoft.com/en-us/azure/active-directory-domain-services/).
