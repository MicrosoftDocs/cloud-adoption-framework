...
- To create a **resource group** to hold resources that share the same permissions and policies:
  ...
  1. Select **Review + create**, and once the review passes, select **Create**.
