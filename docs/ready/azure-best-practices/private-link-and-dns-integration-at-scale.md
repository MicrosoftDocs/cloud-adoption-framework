...
A central network virtual appliance (NVA), such as Azure Firewall, provides Internet-outbound connectivity. [The Firewall can also be used as a DNS proxy to customize DNS forwarding.](https://learn.microsoft.com/en-us/samples/azure/azure-quickstart-templates/azure-firewall-dns-proxy/)
