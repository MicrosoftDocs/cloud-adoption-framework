...
This policy blocks the creation of private endpoints that are in a different subscription than the service itself. If these endpoints are a requirement for certain use cases, we recommend using policy exemptions.
