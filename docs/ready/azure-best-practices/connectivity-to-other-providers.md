...
| Secure VPN Connectivity | [Site-to-Site VPN Gateway](/training/modules/connect-on-premises-network-with-vpn-gateway/2-connect-on-premises-networks-to-azure-using-site-to-site-vpn-gateways) | Enables encrypted secure connectivity over the internet between Azure and other cloud providers with BGP routing support |
