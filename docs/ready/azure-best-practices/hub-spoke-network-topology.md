...
![Examples of a hub-and-spoke network topology](../../_images/azure-best-practices/network-hub-spoke-high-level.png)
_Figure 1: Examples of a hub-and-spoke network topology._
