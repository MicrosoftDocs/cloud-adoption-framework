...
- Your organization intends to deploy resources across one or several Azure regions. Though some traffic across Azure regions is expected, such as traffic between two virtual networks across two different Azure regions, a full mesh network across all Azure regions isn't required.
...
For more information about how you can use Azure Virtual Network Manager to manage virtual networks at scale, see [Virtual Network Manager in Azure landing zones](./azure-virtual-network-manager.md).
