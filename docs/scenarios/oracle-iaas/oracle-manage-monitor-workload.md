...
|:-----------------|:-------------------|:-------------|
|Azure Virtual Network |Oracle database on Azure Virtual Machines landing zone accelerator uses virtual network for Availability Set, Availability Zone, HA, and BCDR by using Oracle Data Guard and Golden Gate. | [Monitoring Azure virtual network data reference](https://learn.microsoft.com/azure/virtual-network/monitor-virtual-network-reference) |
