...
Another access scenario involves an application, such as a mobile or web application, that accesses an Azure service. The application must present its identity, which must then be verified.
