...
Many customers use [ER Studio](https://www.idera.com/products/er-studio/enterprise-data-modeling) and [Orbus Software](https://www.orbussoftware.com) to model their data products before ingestion.
