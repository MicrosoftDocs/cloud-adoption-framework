...
For more information about BCDR considerations for your Azure resources, see [Azure Virtual Desktop disaster recovery](https://learn.microsoft.com/en-us/azure/architecture/example-scenario/wvd/azure-virtual-desktop-multi-region-bcdr).
