...
- **Size of virtual network?** Windows Virtual Desktop VMs reside on a virtual network in Azure. This needs to be appropriatly sized and using appropriate network address ranges as defined in your existing networking architecture.
