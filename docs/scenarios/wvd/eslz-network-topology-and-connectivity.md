...
# Network topology and connectivity for WVD Enterprise-Scale scenario

<!-- cSpell:ignore NVAs VPNs -->

## Review network options

Designing and implementing Windows Virtual Desktop Azure networking capabilities is a critical part of your WVD Landing Zone efforts. You'll need to make networking design decisions to properly support the workloads and services that will be hosted in the WVD Deployment. Azure networking products and services support a wide variety of networking capabilities. How you structure these services and the networking architectures you choose depends on your organization's workload, governance, and connectivity requirements.
...
- **Size of virtual network?** Windows Virtual Desktop VMs reside on a virtual network in Azure. This needs to be appropriately sized and using appropriate network address ranges as defined in your existing networking architecture.
