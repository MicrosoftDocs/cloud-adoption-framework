...
- **Microsoft Entra ID:** A Microsoft Entra instance or a Microsoft Entra tenant should be provided for end-user authentication. In addition, users must be synchronized from Active Directory Domain Services (AD DS) or Microsoft Entra Domain Services (Microsoft Entra Domain Services) to Microsoft Entra ID.
