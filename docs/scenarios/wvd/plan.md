...
- There is no requirement for client access licenses with Windows 10 and Windows 11 Enterprise multi-session, as Windows 10 and Windows 11 Enterprise multi-session does not require a client access license (CAL).
