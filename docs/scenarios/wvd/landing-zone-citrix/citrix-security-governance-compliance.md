...
Review your policy baseline with your platform team per the [Design area: Azure governance](/azure/cloud-adoption-framework/ready/landing-zone/design-area/governance#plan-for-governance) guidelines. Apply policy definitions at the top-level root management group so you can assign them at inherited scopes.
