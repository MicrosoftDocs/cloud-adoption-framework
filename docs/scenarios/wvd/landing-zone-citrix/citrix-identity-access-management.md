...
- Environments that have Azure AD only are possible with support for [Azure AD joined and non-domain joined workloads](https://docs.citrix.com/en-us/citrix-daas/install-configure/azure-joined-ndj-vda-configuration.html).
