...
The process of using your existing image to create a VM which is updated with your new applications and configuration changes, then captured for use as your "new" gold image is not recommended. This process is risky to maintain and is a major cause of desktop virtualization environments becoming static and fragile.
