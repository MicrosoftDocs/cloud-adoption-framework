...
|--|--|
| [AI adoption on Azure](./ai/index.md)| Learn how Microsoft recommends adopting Artificial Intelligence (AI) in your organization with the Microsoft Cloud Adoption Framework.|
| [Azure VMware Solution](../scenarios/azure-vmware/index.md) | Use an Azure service that's built with VMware to migrate your VMware resources to a vSphere-based, single-tenant, private cloud on dedicated infrastructure. Extend hybrid and multicloud agility. Learn how to optimize costs and develop cloud skilling so that you can minimize negative effects on business continuity and reduce the overall migration time. |
