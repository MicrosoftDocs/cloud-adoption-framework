...
|--|--|
|[AI adoption on Azure](./artificial-intelligence/index.md)| Learn how Microsoft recommends adopting Artificial Intelligence (AI) in your organization with the Microsoft Cloud Adoption Framework.|
