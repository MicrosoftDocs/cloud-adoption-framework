...
- **Operational needs:** To make use of the existing VMware skills, licenses (SRM, VMware NSX Advanced Load Balancer (formerly AVI) Load balancer, etc.) and processes you've established across IT teams, while you give team members the ability to grow and adopt cloud competencies over time. Many IT teams can take advantages of following additional benefits offered by Azure VMware Solution.
