...
![Most Common Scenarios](media/eslz-net-table.png)
...
- **Architectural components**
  ...
  ![Scenario 1](media/eslz-net-scenario-1.png)
...
- **Architectural components**
  ...
  ![Scenario 2](media/eslz-net-scenario-2.png)
...
- **Architectural components**
  ...
  ![Scenario 3](media/eslz-net-scenario-3.png)
...
- **Architectural components**
  ...
  ![Scenario 4](media/eslz-net-scenario-4.png)
