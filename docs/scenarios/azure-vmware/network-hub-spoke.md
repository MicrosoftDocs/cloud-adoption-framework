...
- Third Party NVA integration
   ...
   - Return traffic from peered VNETs needs a UDR (User Defined Routes) back to the local interface of the firewall transit mechanism from Expressroute to VPN Gateways
