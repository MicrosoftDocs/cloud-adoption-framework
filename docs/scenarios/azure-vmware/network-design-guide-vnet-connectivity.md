...
:::image type="content" source="media/network-design-guide-figure15.png" alt-text="Figure15. Flowchart that shows the design decision making process for connectivity to Azure Virtual Networks." lightbox="media/network-design-guide-figure15.png":::
