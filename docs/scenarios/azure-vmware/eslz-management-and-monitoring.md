...
- Consider using vRealize Log Insight for [monitoring a NSX-T Data Center environment](https://techdocs.broadcom.com/us/en/vmware-cis/nsx/nsxt-dc/3-2/administration-guide/system-monitoring.html).
