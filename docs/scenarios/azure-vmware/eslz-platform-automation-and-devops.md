...
- When you deploy Azure VMware Solution via the Azure portal, [Azure CLI](/cli/azure/vmware/private-cloud#az_vmware_private_cloud_create), or [Azure PowerShell modules](/powershell/module/az.vmware/new-azvmwareprivatecloud), you see a series of terms and conditions about data protection in the solution. If you're using the Azure Resource Manager APIs directly or deploying via an Azure Resource Manager or Bicep template, consider reviewing these [terms and conditions](https://marketplace.microsoft.com/marketplace/apps/Microsoft.AVS?tab=Overview) before deploying automation.
