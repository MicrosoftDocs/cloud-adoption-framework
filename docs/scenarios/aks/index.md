...
**Prepare for governance and operation of containers at scale:** [AKS landing zone accelerator](./enterprise-scale-landing-zone.md) demonstrates how you can use enterprise-scale landing zones to ensure consistent governance, security, and operations across multiple landing zones for centralized management of containers at scale.
