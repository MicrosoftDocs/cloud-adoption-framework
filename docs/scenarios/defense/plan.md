...
- ***Application landing zone***: The application landing zone are subscriptions for hosting applications. In the sample architecture (*see figure 2*), the blue boxes outline the application landing zones. There are two application landing zone in the architecture: "Application landing zone A1 subscription" and "Application landing zone A2 subscription". The architecture only shows the "Application landing zone A2 subscription" in detail.
