...
***Workload landing zone*** - The workload landing zones are for workloads. The red boxes outline the workload landing zones. There are two workload landing zone subscriptions in the diagram below ("Landing zone A1" and "Landing Zone A2"). The image only shows Landing Zone A2 in detail.
