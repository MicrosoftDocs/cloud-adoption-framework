...
**Azure Batch** and **Azure Cycle Cloud** are both Azure provided 1st party service while **Azure HPC OnDemand Platform (AzHop)** is an automation built on top of Azure Cloud which delivers an end-2-end deployment mechanism for a complete HPC cluster solution in Azure.
