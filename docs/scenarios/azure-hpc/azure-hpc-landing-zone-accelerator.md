...
- Energy (Oil and Gas)
  ...
  - [Resource Organization for Energy HPC](./energy/resource-organization.md)
  - [Governance for Energy HPC](./energy/security-governance-compliance.md)
  - [Security for Energy HPC](./energy/security.md)
  - [Compute for Energy HPC](./energy/compute.md)
...
- Training. Consider the requirements of your model during training, monitoring the CPU and GPU usage.
