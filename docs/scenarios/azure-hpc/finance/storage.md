...
| **Performance (per volume)** | As much as 20,000 IOPS. As much as 100 GiBps throughput. | As much as 100,000 IOPS. As much as 80 GiBps throughput. | As much as 100,000 IOPS, up to 500 Gib/s throughput. | As much as 460,000 IOPS. As much as 36 GiBps throughput. |
