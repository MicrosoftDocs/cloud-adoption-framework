...
description: Learn about key migration connectivity design considerations and recommendations for Oracle Database@Azure, including best practices.
author: moisesjgomez
...
> [!NOTE] 
> The virtual network in the diagram includes both an Azure Storage account and Azure NetApp Files for illustration. Deployments usually use only one storage solution depending on workload and migration requirements.
