...
Building, operating, and managing across all of your resource environments with the same control and processes for governance and operations management brings cloud innovation to disparate environments. New hybrid and multi-cloud scenarios unlock from simplified management, faster app development, and consistent Azure services extended to any infrastructure—enabling consistent development across traditional, cloud-native and distributed edge applications.
...
### ***[ADD PAGE BREAK HERE TO MARK START OF NEW ARC/HYBRID NARRATIVE]***

## Get started with Azure Arc and hybrid-multicloud

Central narrative:
> Unlock hybrid-multi-cloud scenarios (using Azure Arc's unified operations and management)—and accelerate cloud adoption and migration.

***Inputs: Lior/Andrew/Nate/Brian***

### Accelerate cloud adoption and migration with unified ops control plane

Azure Arc's unified operations and management on hybrid, multi-cloud, and edge

Unified operations and management across heterogeneous environments (Azure Arc)

- Central visibility, ops, and compliance
  - (Arc-enabled Windows & Linux VMs-blade servers-SQL server-K8s clusters
    - Attach ASC, Policy, Monitor)
- Security, governance, and monitoring with Azure management services

Unlock new hybrid & multi-cloud scenarios—bringing Azure services & management to any infrastructure

- Build cloud-native apps
  - Deploy & configure applications consistently/at scale with GitOps
    - Easily maintain apps on any certified K8s cluster with runtime policy enforcement
- Modernize databases with Azure data services
  - Always up-to-date data services
    - Elastic scale
- Modernize on-premises datacenters
  - Hyperconverged, Azure connected/managed
    - Bring Azure services to customers' datacenter
...
Scenarios using Azure management tools such as resource tags, Azure Policy, Log Analytics, and more with Azure Arc-enabled servers.
...
### Reference architectures - hybrid, multicloud, and edge

[**TBD sections**]

#### Apps

- <https://docs.microsoft.com/azure/architecture/solution-ideas/articles/ai-at-the-edge>
- <https://docs.microsoft.com/azure/architecture/solution-ideas/articles/ai-at-the-edge-disconnected>
- <https://docs.microsoft.com/azure/architecture/hybrid/azure-functions-hybrid>
- <https://docs.microsoft.com/azure/architecture/hybrid/azure-stack-robo>
- <https://docs.microsoft.com/azure/architecture/hybrid/hybrid-containers>
- <https://docs.microsoft.com/azure/architecture/hybrid/deploy-ai-ml-azure-stack-edge>

#### Data

- <https://docs.microsoft.com/azure/architecture/hybrid/azure-stack-hci-dr>
- <https://docs.microsoft.com/azure/architecture/solution-ideas/articles/backup-archive-on-premises>
- <https://docs.microsoft.com/azure/architecture/solution-ideas/articles/backup-archive-on-premises-applications>
- <https://docs.microsoft.com/azure/architecture/hybrid/hybrid-file-services>
- <https://docs.microsoft.com/azure/architecture/hybrid/azure-file-share>

#### Management

- <https://docs.microsoft.com/azure/architecture/hybrid/arc-hybrid-kubernetes>
- <https://docs.microsoft.com/azure/architecture/hybrid/azure-arc-hybrid-config>
- <https://docs.microsoft.com/azure/architecture/hybrid/azure-arc-sql-server>
- <https://docs.microsoft.com/azure/architecture/hybrid/azure-update-mgmt>
- <https://docs.microsoft.com/azure/architecture/hybrid/azure-automation-hybrid>
- <https://docs.microsoft.com/azure/architecture/hybrid/azure-stack-backup>
- <https://docs.microsoft.com/azure/architecture/solution-ideas/articles/build-high-availability-into-your-bcdr-strategy>
- <https://docs.microsoft.com/azure/architecture/hybrid/azure-stack-vm-dr>
- <https://docs.microsoft.com/azure/architecture/solution-ideas/articles/disaster-recovery-smb-azure-site-recovery>

#### Security

- <https://docs.microsoft.com/azure/architecture/hybrid/hybrid-security-monitoring>
...
- [Azure Stack HCI foundations](https://docs.microsoft.com/learn/paths/azure-stack-hci-foundations/)

## Next steps

Use the best practices guidance in this article series to manage assets using Azure's tools for unified operations.
To get started, [Inventory and Tag resources](./server/best-practices/arc_inventory_tagging.md) to get familiar with the most basic operations management functions. From there, use the best practices to add more operational capability and/or onboard additional resources.
