...
In exploring possible hybrid or multi-cloud scenarios, some customer might be concerned about how to maintaining governance, management and compliance, managing identity and security, migrating data, running development environments, data management tools, and porting applications across scattered resources and environments.
