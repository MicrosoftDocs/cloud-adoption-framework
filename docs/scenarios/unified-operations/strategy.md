...
* A single pane of glass view of all your resources, including Windows, Linux, SQL Servers, and Kubernetes clusters, to track and capture an accurate inventory of IT assets. 
