...
- Power Platform enables low-code / no-code innovation and makes it easy to innovate quickly using SAP data anywhere. One can achieve deeper integration with SAP Business Technology Platform, extend and integrate events between SAP S/4HANA and Microsoft Azure, and benefit from simplified administration and provisioning. Explore a series of articles about the integration capabilities of the [Power Platform with SAP](./sap-lza-powerplatform-fundamental.md) for more details.
