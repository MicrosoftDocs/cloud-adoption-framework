...
- Power Platform enables low-code / no-code innovation and makes it easy to innovate quickly using SAP data anywhere. Achieve a deeper integration with SAP Business Technology Platform, extend and integrate events between SAP S/4HANA and Microsoft Azure, and benefit from simplified administration and provisioning. For more information, see [Power Platform with SAP](./sap-power-platform-fundamental.md).
