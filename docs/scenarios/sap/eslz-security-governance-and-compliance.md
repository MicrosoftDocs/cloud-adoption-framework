...
- Monitor and filter traffic using Azure Monitor, [Azure Network Security Groups (NSGs)](/azure/virtual-network/security-overview), or application security groups.
