...
Azure Landing Zones have specific guidance regarding zero-trust based network security to secure network perimeter and traffic flows. For more information, see [Network security strategies on Azure](/azure/cloud-adoption-framework/ready/landing-zone/design-area/security#zero-trust).
