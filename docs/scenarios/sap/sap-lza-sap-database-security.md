---
title: SAP Security with Azure - SAP on SQL Server Database Security
...
- [SAP Security with Azure - SAP on SQL Server Database Security](./sap-lza-sap-database-security.md) (this article)
