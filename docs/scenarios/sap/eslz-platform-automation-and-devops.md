...
For life cycle purposes it is recommended that each system deploys into a separate Azure resource group.
...
<img src="./media/SAP_estate.png" width=500px>
...
<img src="./media/SAP_DevOps_strategy.png" width=800px>
...
The SAP System is the actual SAP Application, it contains all the Azure artifacts required to host the SAP Application. Refer the [SAP on Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/get-started) MSDocs to get started, plan and consider deployment factors, in detail.
...
<img src="./media/Folderstructure.png" width=400px> 
