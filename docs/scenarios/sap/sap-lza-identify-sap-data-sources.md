...
- Customers with the license and facility, should use SLT because it provides more control to users on the data flows. It offloads the performance burden from the core ERP system, for example shadow tables to capture change.
