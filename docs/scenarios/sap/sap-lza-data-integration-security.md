...
_Figure 2: SAP Source systems represented in the architecture diagram (1)_
...
_Figure 3: Azure ADLS Gen2 security represented in the architecture diagram (2)._
...
To learn more, see [Access control lists](/azure/storage/blobs/data-lake-storage-access-control).

## Azure Data Factory security

![Screenshot that shows ADF.](./media/sap-extend-security-architecture-adf1.png)
_Figure 4: Azure Data Factory security represented in the architecture diagram (3)._
...
Consider encrypting credentials for on-premises data stores in Azure Data Factory.
...
To learn more, see [Encrypt credentials in Azure Data Factory](/azure/data-factory/encrypt-credentials-self-hosted-integration-runtime)
...
To learn more, see [Managed identity for Azure Data Factory](/azure/data-factory/data-factory-service-identity) for more details.
...
To learn more, see [Managed virtual network and managed private endpoints](/azure/data-factory/managed-virtual-network-private-endpoint)
...
_Figure 5: Self-Hosted Integration Runtime (SHIR) security represented in the architecture diagram (4)._
...
To learn more, see [On-premises data store credentials](/azure/data-factory/data-movement-security-considerations#on-premises-data-store-credentials).

### Consider setting up Integration Runtime based on network configuration
...
See [Security considerations for data movement in Azure Data Factory](/azure/data-factory/data-movement-security-considerations) for firewall configurations and allow list setting up for IP addresses mentioned.
...
_Figure 6: Azure Databricks security represented in the architecture diagram (4)._
...
_Figure 7: Azure Synapse security represented in the architecture diagram (5)._
...
Consider how your can use security capabilities to secure the presentation layer, including Power BI.
