...
- Determine whether to use system-assigned or user-assigned [managed identities](/azure/app-service/overview-managed-identity) for your App Service solution when it connects to back-end resources that are protected by Azure Active Directory (Azure AD).
