...
- Enable [Azure Defender for App Service](/azure/security-center/defender-for-app-service-introduction) to assess the security of your web applications, detect threats, get alerts when potential threats are detected so that you can take action to protect your resources.
...
- App Service offers managed SSL certificates, which provide a convenient way to help secure your app by using a trusted SSL certificate. This technology allows the app to use HTTPS to encrypt data in transit and helps ensure that data is transferred securely.
- Use a web application firewall (WAF) like Azure Front Door or Azure Application Gateway to help protect for your web apps from common web vulnerabilities such as SQL injection and XSS attacks. Implementing a WAF can help protect your apps from these types of threats and improve the security of your App Service resources.
