...
- Consistently create backups for applications and data.
  ...
  - A cloud-native process to back up and restore. You can use Azure Backup to schedule backups for your containerized applications and data in Azure Kubernetes Service (AKS). Recovery points are stored offsite and can be used during a regional disaster scenario. Learn [about the protection workdlow](/azure/backup/azure-kubernetes-service-backup-overview).
