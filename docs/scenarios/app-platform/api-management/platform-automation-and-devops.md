...
description: Learn about design considerations and recommendations for platorm automation and DevOps in the Azure API Management landing zone accelerator
...
- A central team (for example, API Management admin team) manages the production API Management environment.
