...
|---|---|---|---|
| [AI Strategy](./strategy.md) | Copilots<br>Azure | &#9744; [Define an AI technology strategy](./strategy.md#define-an-ai-technology-strategy) | &#9744; [Identify AI use cases](./strategy.md#identify-ai-use-cases) <br> &#9744; [Define an AI technology strategy](./strategy.md#define-an-ai-technology-strategy) <br> &#9744; [Develop an AI data strategy](./strategy.md#develop-an-ai-data-strategy-that-grows-with-your-needs) <br> &#9744; [Develop a responsible AI strategy](./strategy.md#develop-a-responsible-ai-strategy) |
