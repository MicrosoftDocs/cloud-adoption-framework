...
- *Get started.* Microsoft has step-by-step guidance for POCs on its various AI services. Use the following table to find the right get started guide.
    ...
    |----------|--------------|
    | Generative AI | Azure PaaS: [Azure AI Foundry](/azure/ai-studio/quickstarts/get-started-playground) and [Azure OpenAI](/azure/ai-services/openai/assistants-quickstart)<br><br>Microsoft Copilots: [Copilot Studio](/microsoft-copilot-studio/fundamentals-get-started)   |
