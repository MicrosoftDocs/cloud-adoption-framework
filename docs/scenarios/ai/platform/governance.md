...
- *Control the models you use.* Use Azure Policy definitions to [allow specific](azure/ai-foundry/how-to/built-in-policy-model-deployment) models in Azure AI Foundry.
...
- *Define baseline content filters for generative AI models.* Use [Azure AI Content Safety](/azure/ai-services/content-safety/overview) to define a baseline content filter for your approved AI models.

- *Ground generative AI models.* Use [system messages](/azure/ai-services/openai/concepts/system-message) and the [retrieval augmented generation](/azure/ai-studio/concepts/retrieval-augmented-generation) (RAG) pattern to govern the output of generative AI models. Test the effectiveness of grounding by using tools like the open-source red teaming framework [PyRIT](https://github.com/Azure/PyRIT).
...
- *Choose the right model for your use case.* Select the AI model that meets your needs without incurring excessive costs. Use less expensive models unless the use case demands a more expensive model. For fine-tuning, maximize time usage within each billing period to avoid extra charges. For more information, see [Azure OpenAI models](/azure/ai-studio/how-to/model-catalog-overview) and [pricing](https://azure.microsoft.com/pricing/details/cognitive-services/openai-service/). Also see [Azure AI Foundry model catalog](/azure/ai-studio/how-to/model-catalog-overview) and [billing information](/azure/ai-studio/how-to/model-catalog-overview#billing) for model deployments. Use Azure Policy definitions to [allow specific](azure/ai-foundry/how-to/built-in-policy-model-deployment) models in Azure AI Foundry.
...
- *Use built-in governance policies.* Use Azure Policy to apply built-in policy definitions for each AI platform you're using. It includes [Azure AI Foundry](/azure/ai-foundry/how-to/azure-policy), [Azure Machine Learning](/azure/machine-learning/policy-reference), [Azure AI services](/azure/ai-services/policy-reference), [Azure AI Search](/azure/search/policy-reference), and others.
