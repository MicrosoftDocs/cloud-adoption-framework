...
|--------|--------|-------|
| Copilot for Microsoft 365 | Use [Copilot for Microsoft 365](/copilot/microsoft-365/microsoft-365-copilot-overview) for an enterprise-wide solution that automates work in Microsoft 365 apps and provides a secure way to chat with business data in Microsoft Graph. | Business |
