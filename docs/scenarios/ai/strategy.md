...
2. **Adopt responsible AI principles as business goals.** Use Microsoft's [responsible AI principles](https://www.microsoft.com/ai/responsible-ai) as your framework for ethical AI development. These six AI principles align with the [NIST AI Risk Management Framework](https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf) and become measurable business objectives that guide project selection and development. Integrate these AI principles into your project planning, development processes, and success metrics.
