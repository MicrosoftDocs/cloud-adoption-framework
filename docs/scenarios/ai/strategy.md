...
1. **Understand AI agents.** An AI agent is a microservice that uses a generative AI model to reason, act, and learn. These systems represent a shift from even RAG applications to decision-making systems that adapt to changing conditions. Given the special nature of agents within an organization, there's separate guidance you should review to adopt agents. See [AI Agent adoption](../../ai-agents/index.md).
