...
- **Deploy AI resources in workload subscriptions.** AI resources need to inherit workload governance policies from the workload management group, whether they're internal or internet-facing. Keep AI resources separate from platform resources. AI resources that platform teams control tend to create development bottlenecks. In the context of an Azure landing zone, deploy AI platforms to application landing zone subscriptions.
