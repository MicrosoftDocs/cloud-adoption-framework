...
| Lake number | Zone        | Container No | Container Name    |
|-------------|-------------|--------------|-------------------|
| 1           | Raw         | 1            | Landing           |
| 1           | Raw         | 2            | Conformance       |
...
Data assets in this zone should be highly governed and well-documented. For example, high-quality sales data might be data in the enriched data zone correlated with other demand forecasting signals such as social media trending patterns for a **data application** that's used for predictive analytics on determining the sales projections for the next fiscal year.

## Development zone or data lake three
...
Sometimes these data products mature, and the enterprise should consider how they promote these **data products** to the curated data zone. In order to keep data product teams responsible for new data products, it's recommended to provide these teams a dedicated folder on the curated data zone. Here they can store the new results and share them with other teams across the organization.
