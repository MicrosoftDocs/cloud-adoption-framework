...
|![Phase 4](../images/icons/4.png)| [Onboard more data landing zones](#phase-4-onboard-additional-data-landing-zones): Once you deploy and evaluate your baseline architecture and align your operating model with cloud-native operations, you can enable more data landing zones.
