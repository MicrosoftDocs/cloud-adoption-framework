...
> [!NOTE]
> This section recommends configurations specific to the cloud scale analytics. It complements Azure Machine Learning documentation and CAF best practices.
