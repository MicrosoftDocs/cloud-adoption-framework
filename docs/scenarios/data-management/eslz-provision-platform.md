---
title: Provision the cloud scale analytics platform
description: Learn how to provision the cloud scale analytics by deploying landing zones and DevOps services.
author: abdale
