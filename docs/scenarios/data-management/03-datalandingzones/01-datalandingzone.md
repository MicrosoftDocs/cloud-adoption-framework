...
The Security and Monitoring Resource group contains core Enterprise Scale components such as Security Centre, Monitoring and Azure Automation. These will be deployed into a single resource group.
