...
For lifecycle management, on how long data should be kept, it's advisable to create a [data lifecycle classification scheme](./govern-requirements.md#data-retention-classification-scheme) to provide different levels of retention classification. A custom microservice lifecycle application could use this to maintain the lifecycle of data within your environment.
