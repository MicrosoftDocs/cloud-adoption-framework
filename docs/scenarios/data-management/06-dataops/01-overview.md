...
4. Central repository and deployment of Data Management Subscription

To centrally govern the data platform infrastructure and not duplicate skills required to build and deploy common data infrastructure pieces required for the Data Management Subscription as well as the various Data Landing Zones, a Platform Group team should be put in place.

The Platform Group team can build, own, and provide the necessary Domain agnostic technology that the Domains need to capture, process, store and serve their data sets.
...
The term DevOps is more of a cultural movement that changes the way of thinking and working, enables individuals and organizations to develop and maintain sustainable work practices and helps accelerating the rate at which businesses realize value.
