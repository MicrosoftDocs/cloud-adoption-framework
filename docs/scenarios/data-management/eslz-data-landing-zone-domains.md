...
Previously, we explained the role of a Domain under [Enterprise Scale Analytics and AI Teams](eslz-persona-and-teams.md#domain-ops-per-domain)  and that Domains help understand [Data Landing Zone Division and Consumption](eslz-data-landing-zone-division-and-consumption.md).
