...
Data lineage plays an important component in an data management and analytics scenario. Lineage is a factor in understanding data quality and validating compliance. Lineage also adds context to data products and products that allows for discoverable and self-serviceable data products.
