...
The data management landing zone is classified as a management function and is at the heart of the enterprise-scale for analytics and AI platform. It is responsible for the governance of the platform and enables communication to ingest data sources from Azure, third-party clouds, and on-premises data sources.
...
It is recommended to have a catalog service provisioned for defining the metadata of the datasets stored across the data landing zones.
...
Although enterprise-scale for analycics and AI uses
...
[Lifecycle management](../best-practices/data-lake-key-considerations.md#lifecycle-management) for enterprise-scale for analytics and AI outlines additional considerations around the different layers in a Data Lake.
...
Enterprise-scale for analytics and AI uses Private Link which relies on having a private DNS zone. Please check with your networking team before deploying another Private DNS as they might have already deployed the services.
