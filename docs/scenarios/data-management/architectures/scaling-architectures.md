...
# Scaling Data Management & Analytics Scenario
...
| Factor   | Description                                                                                                                                                                                                                              |
|----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Latency  | Domains that collaborate on large amounts of data could transfer a large amount of data. In this case you might want to collocate them in the same landing zone or region. Otherwise it will increase latency and for cross region domains you might see an increase cost.                                     |
