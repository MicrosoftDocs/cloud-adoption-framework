...
The question of how many data landing zones an organization requires should be discussed and defined upfront before implementing cloud-scale analytics prescriptive architectural pattern. This is considered to be one of the most important design decisions, because it lays the foundation for an effective and efficient data platform. The number of data landing zones will be determined on factors including organizational alignment (e.g. how many business units required their own data landing zone) and operational considerations (e.g. what is the organizations approach to the alignment of operation resources to business unit specific resources). When well aligned to the organization and operational concerns the correct data landing zone model will prevent enterprises from future migration projects of data products and data assets from one data landing zone to another. It will also allow an effective and consistent scaling of any big data and analytics efforts for the upcoming years.
...
| Cost Allocation                                   | Are shared services like storage accounts paid centrally or do these need to be split by business unit or domain? <br/>Using a separate subscription creates a boundary for cost allocation, but you can also use tags to achieve the same functionality.                                                                                                                                                                                        |
