...
The Data Product Analytics template contains all templates for deploying a data product for analytics and data science inside a Data Management & Analytics Scenario data landing zone.
...
The Batch Data Application template contains all templates for deploying a data product for batch data processing inside a Data Management & Analytics Scenario data landing zone.
...
The Streaming Data Application template contains all templates for deploying a data product for real-time data processing inside a Data Management & Analytics Scenario data landing zone
