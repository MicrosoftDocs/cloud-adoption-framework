# Enterprise-scale for analytics and AI scenario with multiple landing zones
While organizations may begin with a simple implementation of enterprise-scale for analytics and AI, they will quickly want to take advantage of the platform's ability to scale. This scalability is achieved by adding more data landing zones to the platform.  As new business units are ready to migrate their analytics workloads to the cloud, new landing zones can be provisioned and joined to the existing data fabric to provide a controlled environment for their data projects.  As teams that are already working within the enterprise-scale for analytics and AI platform have new projects, they can add new data integrations and data products to their landing zones.
...
![Relecloud Corporation Data Management Landing Zone](images/relecloud-data-management-landing-zone.png)

### Billing Data Landing Zone

![Relecloud Corporation Billing Data Landing Zone](images/relecloud-billing-data-landing-zone.png)
...
## Next steps
 - [Learn more about using Azure Machine Learning as a data product](https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/scenarios/data-management/best-practices/azure-machine-learning)
 - [Learn how to power your data strategy with Azure Synapse Analytics](https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/scenarios/data-management/best-practices/synapse)