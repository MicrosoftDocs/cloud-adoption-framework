...
# Identity and access management for 'Enterprise Scale Analytics and AI' Enterprise-Scale scenario
...
For a successful *data integration* and *product* deployment purposes, the following role assignments are required for each of the options:
