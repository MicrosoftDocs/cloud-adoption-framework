...
The data discovery, or catalog, reflects the state of all the data that the enterprise owns. This data is known as the data estate.

The scanning process connects directly to a data source according to a schedule.
...
Classifications are like subject tags. They're used to mark and identify content of a specific type found within your data estate during scanning. You use sensitivity labels to identify the categories of classification types within your organizational data. You can also use labels to group the policies you wish to apply to each category. It makes use of the same sensitive information types as Microsoft 365, allowing you to stretch your existing security policies and protections across your entire content and data estate.
