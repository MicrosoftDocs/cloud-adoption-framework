...
Option two is to use Azure Databricks to explore **sensitive (personal data)** data. Using a combination of Fernet encryption libraries, user-defined functions (UDF), Databricks secrets, table access control, and dynamic view functions helps to encrypt and decrypt columns.
...
- Identifying **sensitive (personal data)** data
...
> [!NOTE]
> The California Consumer Privacy Act (CCPA) and the European Union General Data Protection Regulation (GDPR) outline privacy rights and obligations. For more information, see [Azure Data Subject Requests for the GDPR and CCPA](/compliance/regulatory/gdpr-dsr-azure).
