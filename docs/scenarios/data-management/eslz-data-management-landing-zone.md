...
See how data quality can be implemented in [Enforcing Data Quality](eslz-data-ingestion#enforcing-data-quality).
...
[Data Lake Lifecycle Management](eslz-data-lake-services#lifecycle-management) for Enterprise Scale Analytics and AI outlines additional considerations around the different layers in a Data Lake.
