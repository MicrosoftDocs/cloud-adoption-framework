...
The [Start with Cloud Adoption Framework enterprise-scale landing zones](../../ready/enterprise-scale/index.md) already uses this concept. Cloud-scale analytics adds [Custom Azure policies](#azure-policies-for-data-management-and-analytics-scenario) to build on these standards. The standards are then applied to our data management landing zones and data landing zones.
