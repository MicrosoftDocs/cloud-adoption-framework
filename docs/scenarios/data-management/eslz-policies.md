...
The [enterprise-scale architecture](../../ready/enterprise-scale/index.md) already uses this concept. Data management and analytics scenario adds [Custom Azure policies](#azure-policies-for-cloud-scale-analytics) to build on these standards. The standards are then applied to our data management landing zones and data landing zones.
