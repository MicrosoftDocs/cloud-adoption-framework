...
The [enterprise-scale architecture](../../ready/enterprise-scale/index.md) already uses this concept. Cloud scale analytics adds [Custom Azure policies](#azure-policies-for-data-management-and-analytics-scenario) to build on these standards. The standards are then applied to our data management landing zones and data landing zones.
...
Cloud scale analytics contains custom policies related to **resource and cost management, authentication, encryption, network isolation, logging, resilience, and more**. See [Data service policies](./architectures/policies.md) for an updated list of policies.
