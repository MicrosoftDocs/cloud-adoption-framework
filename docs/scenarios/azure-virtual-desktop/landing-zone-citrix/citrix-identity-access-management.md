...
- Single sign-on is supported by using [Citrix Federated Authentication Service](https://docs.citrix.com/en-us/federated-authentication-service) when using Microsoft Entra ID or other SAML-based identity providers for authentication.
