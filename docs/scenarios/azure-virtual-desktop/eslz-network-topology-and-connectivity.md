...
:::image type="content" source="./media/network-topology-scenario-1.svg" alt-text="Architecture diagram of the scenario that uses a hub and spoke with hybrid connectivity." lightbox="./media/network-topology-scenario-1.svg" border="false":::
...
- For [Microsoft Entra ID–joined VMs](/azure/architecture/example-scenario/azure-virtual-desktop/azure-virtual-desktop-azure-active-directory-join): Azure Virtual Desktop session hosts create outbound connections to Microsoft Entra ID public endpoints. As a result, no private connectivity configurations are required.
