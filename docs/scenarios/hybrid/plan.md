...
Are there specific skills or extra training this team should take before getting started? To prepare for the readiness phase of your hybrid and multicloud migration journey, consider a [skills readiness path](https://docs.microsoft.com/azure/cloud-adoption-framework/ready/suggested-skills) to add skills in organizational and technical readiness.
