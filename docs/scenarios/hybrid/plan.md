...
- **Extend Azure-based management to VMware vSphere and System Center managed environments**: Connect your VMware and Hyper-V datacenters to Azure, get datacenter-scale inventory, perform VM self-service operations from Azure portal or automation templates, secure, govern, monitor, and patch your virtual machines across on-premises datacenters and Azure using [Azure Arc-enabled VMware vSphere](/azure/azure-arc/vmware-vsphere/overview) and [Azure Arc-enabled System Center Virtual Machine Manager](/azure/azure-arc/system-center-virtual-machine-manager/overview).
