...
| <br> :::image type="icon" source="../../_images/hybrid/hybrid-skills.png"::: | <br> [Learn modules](/learn/azure/): Gain the hands-on skills required to implement, maintain, and support hybrid and multicloud solutions. |
