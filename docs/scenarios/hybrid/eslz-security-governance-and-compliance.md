...
- **Azure Security Center:** [Enable Azure Security Center](https://docs.microsoft.com/en-us/azure/security-center/security-center-get-started) for all subscriptions containing Azure arc-enabled servers for security baseline monitoring 
