...
![Shift from unidirectional cloud migration to bidirectional hybrid and multicloud migration described in next paragraph.](../../_images/hybrid/primary-cloud-provider.png)
