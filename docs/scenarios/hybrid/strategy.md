...
2. **Plan your cloud mix.** Planning your cloud mix involves clearly identifying the hybrid, edge, and multicloud environments you use today, determining the mix that best aligns with your future strategy, and deciding whether each platform should operate independently or through a unified operations model. Once your intended cloud mix is defined, evaluate the configuration that best supports your environments and confirm the Azure landing zone option that fits your hosting approach. Different customers distribute workloads in different ways: hybrid‑first customers keep most workloads on‑premises with selective use of edge, Azure, or other clouds; Azure‑first customers host most workloads in Azure with a few remaining on‑premises or in other environments; and multicloud‑first customers primarily run workloads in another public cloud while strategically placing some in Azure or at the edge. Your chosen mix should guide how each environment is configured and how it supports your overall cloud strategy.
