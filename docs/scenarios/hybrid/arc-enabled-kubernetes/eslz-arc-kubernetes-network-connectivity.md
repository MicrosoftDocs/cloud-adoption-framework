...
- Decide whether to use public or private endpoints when connecting to [Azure Log Analytics](/azure/azure-monitor/logs/log-analytics-workspace-overview) workspaces through ExpressRoute or VPN versus internet connectivity.
