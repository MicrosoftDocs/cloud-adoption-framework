...
<<<<<<< HEAD:docs/scenarios/hybrid/arc-enabled-kubernetes/automation-disciplines.md
...
- Review the [Identity and access management critical design area](./identity-access-management.md) for more information surrounding required permissions.
=======
...
>>>>>>> eadf9c4e48555a968c3f9af6fc59bee01e31416d:docs/scenarios/hybrid/arc-enabled-kubernetes/eslz-arc-kubernetes-automation-disciplines.md
...
<<<<<<< HEAD:docs/scenarios/hybrid/arc-enabled-kubernetes/automation-disciplines.md
- We recommend enabling the auto-upgrade feature for the Azure Arc agents running inside your cluster, this is the default behavior when onboarding a cluster to Azure Arc. Review the [Upgrade Agents guidance](/azure/azure-arc/kubernetes/agent-upgrade) and the [extensions management design area](./extensions-management.md) for more information on the auto-upgrade feature and version support policy.
