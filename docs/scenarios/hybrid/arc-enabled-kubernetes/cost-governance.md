...
- Review the recommendations in the [resource organization](./resource-organization.md) and [governance disciplines](./governance-disciplines.md) critical design area to implement a governance strategy and organize your resources for better cost control and visibility.
