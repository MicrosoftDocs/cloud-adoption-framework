...
By the end of this article, you will understand the critical design considerations and recommendations for security, governance, and compliance with clear Microsoft guidance for Azure Arc-enabled Kuerbentes.
...
As your hybrid and multicloud resources become part of Azure Resource Manager, they can be managed and governed from Azure, this article provides specific guidelines for creating your landing zone when working with Azure Arc-enabled Kubernetes:
