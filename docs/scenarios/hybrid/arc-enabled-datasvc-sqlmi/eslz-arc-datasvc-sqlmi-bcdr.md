...
The following architecture diagram shows how Azure Arc-enabled SQL Managed Instance can be deployed on two separate Kubernetes clusters on different sites for disaster recovery.
