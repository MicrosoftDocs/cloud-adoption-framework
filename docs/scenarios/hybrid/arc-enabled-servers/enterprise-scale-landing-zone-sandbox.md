...
The ArcBox solution is designed to run in your [Azure landing zone sandbox subscription](/azure/cloud-adoption-framework/ready/considerations/sandbox-environments) and will bootstrap all the required Azure resources inside a single resource group.
