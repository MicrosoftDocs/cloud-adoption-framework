...
While the Enterprise-Scale Landing Zone documentation covers Governance and Security as separate topics, Critical Design Area in Arc consolidates both in a single topic which alignes better with the CDA concepts.
