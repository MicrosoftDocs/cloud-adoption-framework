...
:::image type="content" source="../enterprise-scale/media/ns-arch-cust-expanded.png" alt-text="A conceptual architecture diagram of an Azure landing zone." lightbox="/azure/cloud-adoption-framework/ready/landing-zone/enterprise-scale/media/ns-arch-cust-expanded.png":::
