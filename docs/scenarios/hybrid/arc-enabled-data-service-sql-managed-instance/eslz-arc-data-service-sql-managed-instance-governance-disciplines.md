...
- Consider using a [responsible, accountable, consulted, and informed (RACI) parties](../../../strategy/prepare/raci-alignment.md) matrix to support this effort. Build controls into the management scope hierarchy that you define based on [resource consistency](../../../govern/resource-consistency/index.md) and [inventory management](../../../manage/considerations/inventory.md) guidance.
