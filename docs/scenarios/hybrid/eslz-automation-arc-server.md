...
[ ![Azure Arc-enabled data services | Onboarding and VM extension integration.](./media/arc-enabled-servers-onboarding.svg)](./media/arc-enabled-servers-onboarding.svg#lightbox)
