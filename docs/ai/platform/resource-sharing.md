...
- In Azure Machine Learning, use a [hub workspace ](/azure/machine-learning/concept-hub-workspace?view=azureml-api-2) with project workspaces to segment use cases.
