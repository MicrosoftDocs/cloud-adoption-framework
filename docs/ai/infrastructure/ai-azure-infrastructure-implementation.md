...
description: Discover how to build AI on Azure infrastructure with detailed recommendations, architecture guides, and best practices.
...
This article provides implementation recommendations for organizations running AI workloads on Azure infrastructure. After deploying an [Azure landing zone](../ready.md#use-an-azure-landing-zone), you can set up the application landing zone using the [CycleCloud Workspace for Slurm](/azure/cyclecloud/qs-deploy-ccws). Azure CycleCloud Workspace for Slurm offers several benefits for users who want to run AI workloads with the Slurm scheduler.
