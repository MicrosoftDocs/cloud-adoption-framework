...
If you used infrastructure as code to relocate your stateful service, you’ll need to pick a data-relocation tool to move the data. You should review the capabilities of each data-relocation tool and select tool that meets the needs of your workload. Here are tools you can use for data-relocation.
