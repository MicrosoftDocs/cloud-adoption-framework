...
2. **Implement service-specific optimization settings.** Use the Well-Architected Framework's (WAF) [Azure service guides](/azure/well-architected/service-guides/) to align configurations with best practices. This guidance optimizes workloads for Azure
...
> [!div class="nextstepaction"]
> [Secure](/azure/cloud-adoption-framework/secure/)
