...
- Review the [recommended naming and tagging conventions](../docs/ready/azure-best-practices/naming-and-tagging.md#metadata-tags) to define a more comprehensive tagging standard.
