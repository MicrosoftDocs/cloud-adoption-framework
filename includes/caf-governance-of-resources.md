...
1. Establish a cloud secure hybrid VNet.
    ...
    4. Note that VPN tunnels should not be considered production ready circuits for all but the most simple workloads. Anything beyond a few simple workloads requiring on premise connectivity should leverage Azure ExpressRoute.
