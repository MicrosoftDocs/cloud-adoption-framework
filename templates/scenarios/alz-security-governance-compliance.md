---
title: Governance disciplines for title: Azure billing and Active Directory tenant for {{Token-Name}} - {{Insert-accelerator-name}}
description: #Describe how this {{Insert-accelerator-name}} landing zone accelerator can improve security, governance, and compliance of {{Insert-accelerator-name}}.
...
# Governance disciplines for {{Token-LongName}}
